...
/*
    ...
    override suspend fun getTasks(forceUpdate: Boolean): Result<List<Task>> {
        ...
        /* wrapsEspressoIdlingResource ensures that when we start a method
        * like getTasks(), we increment the counter of the idling resource
        * which tell Espresso that I'm busy doing something and then once getTasks()
        * completes, we get out of wrapsEspressoIdlingResource block
        * the countingIdlingResource counter will be decremented which signifies that
        * we are no longer doing the work for get tasks*/
